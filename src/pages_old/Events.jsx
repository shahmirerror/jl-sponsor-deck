...
const legacyEditionStats = [
    { year: '2024', participants: '1,059', prizePool: 'PKR 270,000', universities: 'Nationwide' },
    { year: '2023', participants: '585', prizePool: 'PKR 150,000', universities: 'Karachi' },
    { year: '2022', participants: '156', prizePool: 'PKR 40,000', universities: '1 (MAJU)' },
];
        ...
        <section className="section-padding" style={{ paddingTop: 0 }}>
            <div className="container">
                ...
                <p style={{ color: 'var(--text-secondary)', marginBottom: '18px' }}>
                    Official legacy stats source:{' '}
                    <a
                        href="https://www.jinnahleague.com/legacy"
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{ color: 'var(--accent-gold)' }}
                    >
                        jinnahleague.com/legacy
                    </a>
                </p>
                <div
                    style={{
                ...
                >
                    {legacyEditionStats.map((edition) => (
                        <div key={edition.year} style={{ border: '1px solid var(--border)', padding: '18px' }}>
                            <div className="label" style={{ color: 'var(--accent-gold)', marginBottom: '10px' }}>JL&apos;{edition.year.slice(-2)}</div>
                            <div style={{ color: 'var(--text-secondary)', lineHeight: 1.7, fontSize: '0.95rem' }}>
                                <div><strong style={{ color: 'var(--text-primary)' }}>{edition.participants}</strong> participants</div>
                                <div><strong style={{ color: 'var(--text-primary)' }}>{edition.prizePool}</strong> prize pool</div>
                                <div><strong style={{ color: 'var(--text-primary)' }}>{edition.universities}</strong> universities</div>
                            </div>
                        </div>
                    ))}
                </div>
