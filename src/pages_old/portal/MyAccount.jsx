...
const MyAccount = ({ user, accountActions }) => {
    ...
    const handleSaveName = async (e) => {
        ...
        try {
            ...
            await accountActions.updateMyAccount({ name: trimmedName });
        ...
        <div>
            <div style={{ marginBottom: '20px' }}>
                ...
                <p style={{ color: 'var(--text-secondary)', marginTop: '8px', maxWidth: '720px' }}>
                    Update your profile display name and change your account password.
                </p>
            </div>
            ...
            <Card style={{ padding: '22px', marginBottom: '16px' }}>
                ...
                <form onSubmit={handleSaveName}>
                    <label className="label" style={{ display: 'block', marginBottom: '8px' }}>Profile Name</label>
                    <input
                        type="text"
                        value={displayName}
